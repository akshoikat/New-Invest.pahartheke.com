...
@push('title', 'News Letter')

@section('content')
<div class="widget-content widget-content-area br-6">
    <div class="row">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h4 style="color: gray; font-weight: 600">Subscriber's</h4>
                    ...
                    <td class="text-center">
                        <div class="dropdown custom-dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                {{-- <button type="button" class="dropdown-item" onclick="editNewsLetter('{{ $newsletter->id }}')">Edit</button> --}}
                                <a class="dropdown-item" href="javascript:void(0);" onclick="deleteNewsLetter('{{ $newsletter->id }}')">Delete</a>
                                <form id="delete-form-{{ $newsletter->id }}" action="{{ route('admin.news-letter.destroy', $newsletter->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
